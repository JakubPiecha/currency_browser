# Generated by Django 4.2.5 on 2023-09-09 10:00
import json
import os
...
def delete_currencies_name(apps, schema_editor):
    CurrencyName = apps.get_model("currency", "CurrencyName")
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(load_currencies_names, delete_currencies_name)]
